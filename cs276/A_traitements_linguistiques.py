...
def traitements_linguistiques(useful_tokens):
    ...
    print("Question 1 :")
    T = len(useful_tokens)
    print("Le nombre T de tokens dans cs276 : ", T)
    ...
    print("La taille M du vocabulaire dans cs276 est :", M)
    ...
    print("Le nombre T2 de tokens pour la moitié de la collection cs276 est : ", T2)
    M2 = len(unique_half_useful_tokens)
    print("La taille M2 du vocabulaire pour la moitié de la collection cs276 est :", M2)
    b = math.log(M / M2, 2)
    print("b = ", b)
    k = M / T ** b
    print("k = ", k)
